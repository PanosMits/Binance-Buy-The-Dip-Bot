...
const seedBuyOrders = `
    ...
    VALUES
        ('fa496854-0ed7-4cc5-b429-539cbe8cf70c', 'aba57496-13ff-4126-be5a-c8361d43a1a4', 'EOSDOWN/USDT', 1620393191, 4310.3448275862065, 0.00229, 10, true),
        ('1ecfc56d-13a4-4dcf-aed9-b1e9b5abd230', 'df02c9c3-f6b9-4347-836e-9518e3c77e13', 'BTC/USDT', ${dayjs().subtract(10, 'hour').unix()}, '0.00018052115', '55395.17', 10, true),
        ('f1978060-6561-43b0-98e3-6e09f4e432c6', '1ebe8f76-a87a-432c-a72d-e1d55943c558', 'BTC/USDT', ${dayjs().subtract(1, 'day').unix()}, '0.00019138668', '52250.24', 10, true),
        ('a23b6afc-8035-4496-8edb-8b6f6a471d4a', '7549bbb9-be9c-41f5-b5c5-d26cd8e99924', 'BTC/USDT', ${dayjs().subtract(2, 'day').unix()}, '0.0001995994', '50100.35', 10, true),
        ('487adc81-4506-4847-9203-8893247f3d02', '454c4a5e-7536-43b8-9da8-3608637a83f5', 'ETH/USDT', ${dayjs().subtract(11, 'hour').unix()}, '0.00352051934', '2840.49', 10, true),
